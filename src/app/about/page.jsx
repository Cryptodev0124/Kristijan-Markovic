      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2 text-white">
          <div className="flex flex-col gap-12 justify-center">
            ...
            <p className="text-lg">
              My passion for blockchain, smart contracts, and dApp development drives my approach to blockchain innovation
            </p>
            <span className="italic">
              Kristijan Markovic / Blockchain Developer
            </span>
            <motion.svg
            ...
            >
              ...
              <div className="flex justify-between h-48">
                <div className="w-1/3 ">
                  ...
                  <div className="p-3 text-sm italic">
                    I provided blockchain solutions, applying a range of technologies
                  ...
                  <div className="p-3 text-sm font-semibold">
                    My time working on Blockchain Development:
                  </div>
